...
const SAMPLE_STICKERS = [
  ...
  { name: "MetLife Stadium",  team: "USA", rarity: "EPIC",      cat: "stadium", flag: "🏟️", color: "#A855F7", bg1: "#002868", bg2: "#BF0A30", img: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/35/MetLife_Stadium_New_York.jpg/440px-MetLife_Stadium_New_York.jpg" },
  ...
  { name: "Azteca Stadium",   team: "MEX", rarity: "RARE",      cat: "stadium", flag: "🏟️", color: "#00D97E", bg1: "#006847", bg2: "#CE1126", img: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/eb/Azteca_stadium.jpg/440px-Azteca_stadium.jpg" },
  ...
  { name: "New York City",    team: "USA", rarity: "RARE",      cat: "city",    flag: "🗽", color: "#00D97E", bg1: "#002868", bg2: "#3C3B6E", img: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Southwest_corner_of_Central_Park%2C_looking_east%2C_NYC.jpg/440px-Southwest_corner_of_Central_Park%2C_looking_east%2C_NYC.jpg" },
  ...
  { name: "Ciudad de México", team: "MEX", rarity: "UNCOMMON",  cat: "city",    flag: "🇲🇽", color: "#4A6FFF", bg1: "#006847", bg2: "#CE1126", img: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Mexico_City_Zocalo_12.2013.jpg/440px-Mexico_City_Zocalo_12.2013.jpg" },
...
function StickerPreview({ name, team, rarity, flag, color, bg1, bg2, img, cat }: {
  name: string; team: string; rarity: string; flag: string;
  color: string; bg1: string; bg2: string; img: string; cat: string;
}) {
  const initials = name.split(" ").map((w) => w[0]).join("").slice(0, 2).toUpperCase();
  return (
    <div className="flex-shrink-0 w-28 rounded-2xl overflow-hidden border-2 hover:scale-105 transition-all duration-200"
      ...
      <div className="h-36 relative overflow-hidden"
        ...
        {/* Cat badge */}
        {cat !== "player" && (
          <div className="absolute top-3 right-1.5 z-20 text-[8px] font-black px-1.5 py-0.5 rounded-full uppercase"
      ...
      <div className="px-2 py-1.5 bg-[#0d0d1a]">
        ...
        <p className="text-[9px] font-black mt-0.5" style={{ color }}>{rarity}</p>
      </div>
    </div>
  );
}
